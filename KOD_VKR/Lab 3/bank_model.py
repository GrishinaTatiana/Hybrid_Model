...
class BankModel(Model):
    def __init__(self, width=20, height=10, n_tellers=2, spawn_rate=0.1):
        ...
        # Счетчики статистики
        self.left_by_heat = 0
        self.left_by_error = 0  # Уникальный функционал из bank_model.py
        self.served_count = 0
        ...
        self.heat_resistant_error = 0  # Уникальный функционал из bank_model.py
        self.heat_sensitive_error = 0  # Уникальный функционал из bank_model.py
